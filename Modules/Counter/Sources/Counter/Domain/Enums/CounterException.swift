...
extension CounterException: Exception {
    ...
    public var code: String {
        switch self {
            ...
            case .cantCreateCounter: return "co.dm.02"
            case .cantIncrementCounter: return "co.dm.03"
            case .cantDecrementCounter: return "co.dm.04"
            case .cantDeleteCounters: return "co.dm.05"
        }
    }
